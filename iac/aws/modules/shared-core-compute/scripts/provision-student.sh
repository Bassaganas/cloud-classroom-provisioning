...
#
# Student ID format: {character}_{suffix}  (e.g. legolas_xy37, gandalf_a1b2)
# Generated by generate_student_identity.py — LOTR character + 4-char hex UUID
#
...
GROOVY
    ...
    groovy_script="${groovy_script//FULLNAME/\"${STUDENT_ID}\"}"  # character name is already identity (e.g. legolas_xy37)
