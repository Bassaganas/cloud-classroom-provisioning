...
- Assets: logos, screenshots, diagrams, and demo GIFs/videos in assets/
...
### Step 2: Capture Demo Flows (GIF/Video)

Automate and record key user flows for the README Demo section:

**Automated Demo Workflow:**

1. Ensure the LOTR SUT frontend is running (e.g., http://localhost:8000)
...
3. Run the capture script:
  ```bash
  python scripts/capture_flows.py
  ```
  This will record two flows as .webm videos in the assets/ folder:
  - Bargaining for an article and showing it in inventory
  - Completing a quest minigame
4. (Optional) Convert .webm videos to GIFs for embedding in the README:
  ```bash
  ffmpeg -i assets/flow_bargain.webm assets/flow_bargain.gif
  ffmpeg -i assets/flow_quest.webm assets/flow_quest.gif
  ```

**Flows are defined in scripts/capture_flows.py and are easy to update as the UI evolves.**

**Demo flows are deliberately slow-paced for clarity.**
